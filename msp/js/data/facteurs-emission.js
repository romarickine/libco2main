...
export const FE_NUMERIQUE = {
  ...
  ordi_portable_an: 30, // SOURCÉ (partiel) — bilan d'émissions ISLEAN (2019, réf. GreenIT) : 156 kgCO2e fabrication / 5 ans amortissement
...
export const FE_GROS_MATERIEL_STANDARD = 0.19; // kgCO2e/€ — équipements lourds "standard" (kinéCO2)
...
export const ACTIONS = [
  ...
  { id: "dc4", poste: "deplacements_patientele", titre: "Afficher en salle d'attente une carte isochrone comparant marche/vélo et voiture autour de la structure", source: "ESTIMÉ — outil de visualisation concret pour appuyer l'action « inciter aux mobilités actives » : <a href=\"../iso/\" target=\"_blank\" rel=\"noopener\">La carte du sans-voiture</a>, un autre outil Lib&CO2, génère gratuitement une carte des zones plus rapidement accessibles à pied, à vélo ou en vélo électrique qu'en voiture autour de la MSP — calculée sur le vrai réseau de rues et le relief réel, pas à vol d'oiseau. Particulièrement pertinent pour une structure regroupant plusieurs praticiens, donc davantage de passages. Effet non chiffré par une étude ; estimé par analogie avec les actions de communication déjà présentes.", hasPct: true, defaultPct: 15, maxReduction: 0.12, cost: "gratuit", coutKg: "0 € — carte téléchargeable gratuitement, à imprimer" },
