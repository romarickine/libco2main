...
export const ACTIONS = [
  ...
  { id: "dc4", poste: "deplacements_patientele", titre: "Afficher en salle d'attente une carte isochrone comparant marche/vélo et voiture autour du cabinet", source: "ESTIMÉ — outil de visualisation concret pour appuyer l'action « inciter aux mobilités actives » : <a href=\"../iso/\" target=\"_blank\" rel=\"noopener\">La carte du sans-voiture</a>, un autre outil Lib&CO2, génère gratuitement une carte des zones plus rapidement accessibles à pied, à vélo ou en vélo électrique qu'en voiture autour de votre cabinet — calculée sur le vrai réseau de rues et le relief réel, pas à vol d'oiseau. Effet non chiffré par une étude ; estimé par analogie avec les actions de communication déjà présentes.", hasPct: true, defaultPct: 15, maxReduction: 0.12, cost: "gratuit", coutKg: "0 € — carte téléchargeable gratuitement, à imprimer" },
